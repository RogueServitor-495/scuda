 ...
 * @param n SEND_ONLY
 * @param k SEND_ONLY
 * @param alpha SEND_ONLY SIZE:8
 * @param A SEND_ONLY
 * @param lda SEND_ONLY
 * @param B SEND_ONLY
 * @param ldb SEND_ONLY
 * @param beta SEND_ONLY SIZE:8
 * @param C SEND_ONLY
 * @param ldc SEND_ONLY
 */
...
/**
 * @param functions SEND_RECV
 * @param numFunctions SEND_ONLY
 * @param mod SEND_ONLY
 */
 ...
 * @param paramOffset SEND_RECV
 * @param paramSize SEND_RECV
 */
 ...
 * @param hGraph SEND_ONLY
 * @param dependencies SEND_RECV
 * @param dependencyData SEND_RECV
 * @param numDependencies SEND_ONLY
 * @param mode SEND_ONLY
 */
 ...
 * @param input SEND_RECV
 * @param remaining SEND_RECV
 * @param useFlags SEND_ONLY
...
/**
 * @param kernelPtr SEND_RECV
 * @param entryFuncAddr SEND_RECV
 */
cudaError_t cudaGetKernel(cudaKernel_t* kernelPtr, const void* entryFuncAddr);
/**
 * @param handle SEND_ONLY
 * @param transa_array SEND_ONLY
 * @param transb_array SEND_ONLY
 * @param m_array SEND_ONLY
 * @param n_array SEND_ONLY
 * @param k_array SEND_ONLY
 * @param alpha_array SEND_ONLY
 * @param Aarray SEND_ONLY
 * @param lda_array SEND_ONLY
 * @param Barray SEND_ONLY
 * @param ldb_array SEND_ONLY
 * @param beta_array SEND_ONLY
 * @param Carray SEND_ONLY
 * @param ldc_array SEND_ONLY
 * @param group_count SEND_ONLY
 * @param group_size SEND_ONLY
 */
