...
def main():
    ...
    cublas_ast: ParsedData = parse_file("/usr/local/cuda-12.4/targets/x86_64-linux/include/cublas_api.h", options=options)
    cudart_ast: ParsedData = parse_file(
        "/usr/local/cuda-12.4/targets/x86_64-linux/include/cuda_runtime_api.h", options=options
    )
    cublasLt_ast: ParsedData = parse_file("/usr/local/cuda-12.4/targets/x86_64-linux/include/cublasLt.h",options=options)
